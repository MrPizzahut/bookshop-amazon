...
%>
  ...
  <table> 
    <tr> 
      ...
      <td width="150">amount of price</td>
    </tr>   
<%
...
<form method="post" action="buyPro.jsp" name="buyinput">
 <table>
   <tr> 
    <td  colspan="2"><font size="+1" ><b>information of order</b></font></td>
   </tr>
   <tr> 
   ...
   <tr> 
     <td  width="200" align="left">account</td>
...
<table>
  <tr> 
   <td  colspan="2" align="center"><font size="+1" ><b>shipping address</b></font></td>
  </tr>
  <tr> 
    <td  width="200" align="left">Name</td>
    <td  width="400" align="left">
