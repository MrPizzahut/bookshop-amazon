...
<%
 ...
 if(book_kind.equals("100"))
	      ...
	      book_kindName="all";
%>
 <h3><b><%=book_kindName%> category's new books</b></h3>
    <a href="shopMain.jsp">go to main</a>
<%
...
%>
  <table> 
    ...
    <tr height="30" bgcolor="<%=value_c%>"> 
       <td width="350">Publishing company : <%=bookList.getPublishing_com()%></td> 
    </tr>
    <tr height="30" bgcolor="<%=value_c%>"> 
       <td width="350">Author : <%=bookList.getAuthor()%></td>
    </tr>
    <tr height="30" bgcolor="<%=value_c%>"> 
       <td width="350">list price : <%=NumberFormat.getInstance().format(bookList.getBook_price())%><br>
